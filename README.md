...
Navigate to ==> http://localhost:5173/ in your web browser. Here, you can register an admin account to access the administrative features of the application, Password should be six characters
